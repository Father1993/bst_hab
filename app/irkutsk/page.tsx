        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
            <div className='bg-zinc-900/60 backdrop-blur-md rounded-xl p-6 border border-zinc-800/50'>
              ...
              <a href={`tel:${IRKUTSK_OFFICE.phoneRaw}`} className='text-gray-400 hover:text-[#FFD700] transition-colors block'>
            ...
            <div className='bg-zinc-900/60 backdrop-blur-md rounded-xl p-6 border border-zinc-800/50'>
              ...
              <a href={`tel:${IRKUTSK_OFFICE.phoneLocalRaw}`} className='text-gray-400 hover:text-[#FFD700] transition-colors block mb-1'>
            ...
            <div className='bg-zinc-900/60 backdrop-blur-md rounded-xl p-6 border border-zinc-800/50'>
              ...
              <a href={`mailto:${IRKUTSK_OFFICE.email}`} className='text-gray-400 hover:text-[#FFD700] transition-colors text-sm'>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            priceRange: '$$',
            description: 'Производство и аренда модульных конструкций: бытовки, гаражи, строительные модули в Иркутске',
          }),
        }}
      />
    </main>
