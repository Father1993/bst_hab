      ...
      <nav className='container mx-auto px-4'>
        <div className='flex justify-between items-center py-4'>
          ...
          <div className='hidden lg:block'>
            <button className='bg-[#FFD700] text-black px-6 py-2 rounded-lg hover:bg-[#FFD700]/90 transition-colors font-semibold'>
              Заказать звонок
            </button>
          </div>
          ...
          <div className='container mx-auto px-4 py-4'>
            <div className='flex flex-col space-y-4'>
              ...
              <div className='pt-4 border-t border-zinc-800'>
                <button className='w-full bg-[#FFD700] text-black px-6 py-2 rounded-lg hover:bg-[#FFD700]/90 transition-colors font-semibold'>
                  Заказать звонок
                </button>
              </div>
